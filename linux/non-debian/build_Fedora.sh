...
cp ansys_python_manager.desktop package_Fedora/usr/share/applications
...
cp installer_CentOS.sh installer_Fedora.sh
cp updater_CentOS.sh updater_Fedora.sh
zip -r ./manual_build/Ansys-python-manager_Fedora.zip ansys_python_manager_Fedora.rpm installer_Fedora.sh updater_Fedora.sh
