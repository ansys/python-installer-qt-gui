...
cp ansys_python_manager.desktop package_CentOS/usr/share/applications
...
zip -r ./manual_build/Ansys-python-manager_CentOS.zip ansys_python_manager_CentOS.rpm installer_CentOS.sh updater_CentOS.sh
